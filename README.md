...
running command...
$ corev1 (--version)
@oclif/plugin-test-core-v1/0.2.18 linux-x64 node-v20.20.2
$ corev1 --help [COMMAND]
USAGE
  $ corev1 COMMAND
...
...
_See code: [src/commands/core-v1.ts](https://github.com/oclif/plugin-test-core-v1/blob/0.2.18/src/commands/core-v1.ts)_
